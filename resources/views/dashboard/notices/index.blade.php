...
@section('content')
    ...
    @if (session('success'))
        <div
            class="bg-emerald-500/10 border border-emerald-500/20 text-emerald-500 p-4 mb-6 text-xs font-bold uppercase tracking-widest">
            {{ session('success') }}
        </div>
    @endif
    ...
    @if ($errors->any())
        <div
            class="bg-red-500/10 border border-red-500/20 text-red-500 p-4 mb-6 text-xs font-bold uppercase tracking-widest">
            {{ $errors->first() }}
        </div>
    @endif
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="bg-[#262626] border border-[#374151] rounded-sm p-6 shadow-lg h-fit">
            ...
            <form onsubmit="event.preventDefault(); alert('Aviso enviado (simulación)');" class="space-y-6">
                ...
                <div>
                    <label
                        class="block text-xs uppercase tracking-widest text-[#9CA3AF] mb-2 font-bold">Destinatarios</label>
                ...
                <div class="flex items-center gap-2">
                    ...
                    <label for="urgent" class="text-xs uppercase tracking-widest text-[#9CA3AF] font-bold">Marcar como
                        Importante</label>
                </div>
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-[#262626] border border-[#374151] p-6 group hover:border-[#F3F4F6] transition-colors">
                <div class="flex justify-between items-start mb-4">
                    <div class="flex items-center gap-3">
                        ...
                        <span
                            class="bg-red-500/10 text-red-500 px-2 py-0.5 rounded text-[10px] font-bold uppercase border border-red-500/20">Importante</span>
                    </div>
                    <span class="text-xs text-[#52525b]">Hace 2 días</span>
                </div>
                <p class="text-[#9CA3AF] text-sm mb-4 leading-relaxed">Se han actualizado las políticas de comisiones. Por
                    favor revisen su panel de facturación para más detalles sobre los nuevos cargos aplicables a partir del
                    próximo mes.</p>
                <div
                    class="flex gap-4 text-xs text-[#52525b] uppercase tracking-wide font-mono border-t border-[#374151] pt-4">
            ...
            <div class="bg-[#262626] border border-[#374151] p-6 group hover:border-[#F3F4F6] transition-colors">
                ...
                <p class="text-[#9CA3AF] text-sm mb-4 leading-relaxed">El equipo de NexoApp les desea unas felices fiestas.
                    El soporte técnico operará con horario reducido los días 24 y 25.</p>
                <div
                    class="flex gap-4 text-xs text-[#52525b] uppercase tracking-wide font-mono border-t border-[#374151] pt-4">
                    <span>Enviado a: Todos</span>
                    <span>•</span>
