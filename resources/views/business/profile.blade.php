...
<i class="fa-solid fa-right-from-bracket mr-2"></i> Cerrar Sesión
    ...
    <main class="flex-grow max-w-7xl mx-auto w-full px-6 py-12">
        ...
        <div class="relative min-h-[600px]">
            ...
            <!-- DEBUG: Verificar que $services llega -->
<pre style="background: #000; color: #0f0; padding: 10px; margin: 10px; font-size: 10px; overflow: auto;">
SERVICIOS: {{ json_encode($services, JSON_PRETTY_PRINT) }}
</pre>
