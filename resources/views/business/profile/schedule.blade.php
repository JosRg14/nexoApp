        ...
        <div class="bg-[#262626] border border-[#374151] rounded-sm p-6">
            ...
            <form id="horario-negocio-form" class="space-y-3">
                ...
                <div class="bg-[#1a1a1a] border border-[#374151] rounded-lg p-3">
                    <div class="flex flex-wrap items-center gap-4 mb-2">
                        <div class="flex items-center gap-3">
                            <input type="checkbox" id="negocio_martes_abierto" class="negocio-checkbox w-4 h-4 accent-yellow-500" data-day="martes">
                ...
                <div class="bg-[#1a1a1a] border border-[#374151] rounded-lg p-3">
                    <div class="flex flex-wrap items-center gap-4 mb-2">
                        <div class="flex items-center gap-3">
                            <input type="checkbox" id="negocio_miercoles_abierto" class="negocio-checkbox w-4 h-4 accent-yellow-500" data-day="miercoles">
                ...
                <div class="bg-[#1a1a1a] border border-[#374151] rounded-lg p-3">
                    <div class="flex flex-wrap items-center gap-4 mb-2">
                        <div class="flex items-center gap-3">
                            <input type="checkbox" id="negocio_jueves_abierto" class="negocio-checkbox w-4 h-4 accent-yellow-500" data-day="jueves">
                ...
                <div class="bg-[#1a1a1a] border border-[#374151] rounded-lg p-3">
                    <div class="flex flex-wrap items-center gap-4 mb-2">
                        <div class="flex items-center gap-3">
                            <input type="checkbox" id="negocio_viernes_abierto" class="negocio-checkbox w-4 h-4 accent-yellow-500" data-day="viernes">
                ...
                <div class="bg-[#1a1a1a] border border-[#374151] rounded-lg p-3">
                    <div class="flex flex-wrap items-center gap-4 mb-2">
                        <div class="flex items-center gap-3">
                            <input type="checkbox" id="negocio_sabado_abierto" class="negocio-checkbox w-4 h-4 accent-yellow-500" data-day="sabado">
                ...
                <div class="bg-[#1a1a1a] border border-[#374151] rounded-lg p-3">
                    <div class="flex flex-wrap items-center gap-4 mb-2">
                        <div class="flex items-center gap-3">
                            <input type="checkbox" id="negocio_domingo_abierto" class="negocio-checkbox w-4 h-4 accent-yellow-500" data-day="domingo">
